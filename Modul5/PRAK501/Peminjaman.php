...
if (isset($_GET['id_hapus'])) {
    ...
    if (hapusPeminjaman($id_peminjaman)) {
        ...
        echo "<script>alert('Gagal menghapus data peminjaman!'); window.location.href='Peminjaman.php';</script>";
    }
}

$data_peminjaman = getPeminjaman();
?>
        ...
        <tbody>
            ...
            if (!empty($data_peminjaman)) {
                ...
                foreach ($data_peminjaman as $pinjam) {
                    ...
                    echo "<td>
                            <a href='FormPeminjaman.php?id_edit=" . $pinjam['id_peminjaman'] . "' class='btn btn-edit'>Edit</a>
                            <a href='Peminjaman.php?id_hapus=" . $pinjam['id_peminjaman'] . "' class='btn btn-delete' onclick=\"return confirm('Yakin ingin menghapus data peminjaman ini?');\">Hapus</a>
                          </td>";
                    echo "</tr>";
                }
            } else {
